...
#MAX_STEPS = 1000
#AGENT_AMBITION = 4 # 1 should be the base value here. This means that any field which has been visited less and is an actual improvement distance wise is chosen immediately
#BACKSTEP_PENALTY = 4
